...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = '2. Que signifie le terme "compilation" dans le cadre du développement informatique ?';// Met la question de la 2
            rep1.innerHTML = "- Traduire un programme source en langage machine";                           // Change la reponse 1
            rep2.innerHTML = "- Exécuter un programme directement";                                         // Change la reponse 2
            rep3.innerHTML = "- Tester un programme avant son exécution";                                   // Change la reponse 3
            rep4.innerHTML = "- Organiser un programme en plusieurs fichiers";                              // Change la reponse 4
            ...
            question.innerText = '3. Qu’est-ce qu’une boucle "for" en programmation ?';                     // Met la question de la 3
            rep1.innerHTML = "- Une structure conditionnelle";                                              // Change la reponse 1
            rep2.innerHTML = "- Une structure qui répète un bloc de code un nombre déterminé de fois";      // Change la reponse 2
            rep3.innerHTML = "- Une fonction récursive";                                                    // Change la reponse 3
            rep4.innerHTML = "- Un type de donnée";                                                         // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.NSI[1][1];          // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.NSI[1][1]= score;                    // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau moyen du test de NSI !");                       // Afficher message pour félicité
