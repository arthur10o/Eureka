...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Quel est le principal gaz dans l'atmosphère terrestre ?";              // Met la question de la 2
            rep1.innerHTML = "- Oxygène";                                                                   // Change la reponse 1
            rep2.innerHTML = "- Azote";                                                                     // Change la reponse 2
            rep3.innerHTML = "- Dioxyde de carbone";                                                        // Change la reponse 3
            rep4.innerHTML = "- Hélium";                                                                    // Change la reponse 4
            ...
            question.innerText = '3. Quelle est la vitesse de la lumière dans le vide ?';                   // Met la question de la 2
            rep1.innerHTML = "- 300 000 km/s";                                                              // Change la reponse 1
            rep2.innerHTML = "- 150 000 km/s";                                                              // Change la reponse 2
            rep3.innerHTML = "- 3 000 km/s";                                                                // Change la reponse 3
            rep4.innerHTML = "- 30 000 km/s";                                                               // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.physique[0][1];     // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.physique[0][1]= score;               // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau facile du test de physique !");                 // Afficher message pour félicité
