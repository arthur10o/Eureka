...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Un cercle a un rayon de 5 cm. Quelle est sa circonférence ?";          // Met la question de la 2
            rep1.innerHTML = "- 31,4 cm";                                                                   // Change la reponse 1
            rep2.innerHTML = "- 25,12 cm";                                                                  // Change la reponse 2
            rep3.innerHTML = "- 15,7 cm";                                                                   // Change la reponse 3
            rep4.innerHTML = "- 50 cm";                                                                     // Change la reponse 4
            ...
            question.innerText = "3. Résoudre l’équation suivante : 2(x + 3) = 18. Quelle est la valeur de x ?";// Met la question de la 3
            rep1.innerHTML = "- 5";                                                                         // Change la reponse 1
            rep2.innerHTML = "- 6";                                                                         // Change la reponse 2
            rep3.innerHTML = "- 4";                                                                         // Change la reponse 3
            rep4.innerHTML = "- 3";                                                                         // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.mathe[2][1];        // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.mathe[2][1]= score;                  // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau difficile du test de mathe !");                   // Afficher message pour félicité
