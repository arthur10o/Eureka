...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Quelle civilisation antique a construit les pyramides de Gizeh ?";     // Met la question de la 2
            rep1.innerHTML = "- Les Romains";                                                               // Change la reponse 1
            rep2.innerHTML = "- Les Aztèques";                                                              // Change la reponse 2
            rep3.innerHTML = "- Les Égyptiens";                                                             // Change la reponse 3
            rep4.innerHTML = "- Les Grecs";                                                                 // Change la reponse 4
            ...
            question.innerText = '3. Quelle bataille a marqué la fin du Premier Empire en 1815 ?';          // Met la question de la 2
            rep1.innerHTML = "- Austerlitz";                                                                // Change la reponse 1
            rep2.innerHTML = "- Trafalgar";                                                                 // Change la reponse 2
            rep3.innerHTML = "- Waterloo";                                                                  // Change la reponse 3
            rep4.innerHTML = "- Verdun";                                                                    // Change la reponse 4
            rep_corect = "rep3";                                                                            // Change la reponse valide
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.histoire[1][1];     // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.histoire[1][1]= score;               // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau moyen du test d'histoire !");                   // Afficher message pour félicité
