...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Dans la mythologie nordique, comment s’appelle le loup qui doit tuer Odin lors du Ragnarök ?";// Met la question de la 2
            rep1.innerHTML = "- Fenrir";                                                                    // Change la reponse 1
            rep2.innerHTML = "- Sleipnir";                                                                  // Change la reponse 2
            rep3.innerHTML = "- Jörmungand";                                                                // Change la reponse 3
            rep4.innerHTML = "- Hati";                                                                      // Change la reponse 4
            ...
            question.innerText = '3. Quelle est la seule lettre qui ne figure pas dans le tableau périodique des éléments ?';// Met la question de la 2
            rep1.innerHTML = "- J";                                                                         // Change la reponse 1
            rep2.innerHTML = "- W";                                                                         // Change la reponse 2
            rep3.innerHTML = "- Q";                                                                         // Change la reponse 3
            rep4.innerHTML = "- X";                                                                         // Change la reponse 4
            rep_corect = "rep1";                                                                            // Change la reponse valide
            ...
            question.innerText = '4. Quel pays a pour devise "Ordem e Progresso" (Ordre et Progrès) sur son drapeau ?';// Met la question de la 2
            rep1.innerHTML = "- Mexique";                                                                   // Change la reponse 1
            rep2.innerHTML = "- Brésil";                                                                    // Change la reponse 2
            rep3.innerHTML = "- Argentine";                                                                 // Change la reponse 3
            rep4.innerHTML = "- Portugal";                                                                  // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.culture_G[3][1];    // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.culture_G[3][1]= score;              // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau expert du test de culture G !");                // Afficher message pour félicité
