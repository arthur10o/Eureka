...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. En quelle année a eu lieu la Révolution française ?";                  // Met la question de la 2
            rep1.innerHTML = "- 1492";                                                                      // Change la reponse 1
            rep2.innerHTML = "- 1789";                                                                      // Change la reponse 2
            rep3.innerHTML = "- 1815";                                                                      // Change la reponse 3
            rep4.innerHTML = "- 1914";                                                                      // Change la reponse 4
            ...
            question.innerText = "3. Quel mur symbolisait la division entre l'Est et l'Ouest pendant la Guerre froide ?";// Met la question de la 2
            rep1.innerHTML = "- Le mur d'Hadrien";                                                          // Change la reponse 1
            rep2.innerHTML = "- Le mur de Berlin";                                                          // Change la reponse 2
            rep3.innerHTML = "- La Grande Muraille de Chine";                                               // Change la reponse 3
            rep4.innerHTML = "- Le mur de la Manche";                                                       // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.histoire[0][1];     // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.histoire[0][1]= score;               // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau facile du test d'histoire !");                  // Afficher message pour félicité
