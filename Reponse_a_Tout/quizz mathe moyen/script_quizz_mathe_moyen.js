...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = '2. Quel est le périmètre d’un rectangle de longueur 8 cm et de largeur 3 cm ?';// Met la question de la 2
            rep1.innerHTML = "- 24 cm";                                                                     // Change la reponse 1
            rep2.innerHTML = "- 22 cm";                                                                     // Change la reponse 2
            rep3.innerHTML = "- 16 cm";                                                                     // Change la reponse 3
            rep4.innerHTML = "- 14 cm";                                                                     // Change la reponse 4
            ...
            question.innerText = '3. Quelle est la valeur de 5³ ?';                                         // Met la question de la 3
            rep1.innerHTML = "- 125";                                                                       // Change la reponse 1
            rep2.innerHTML = "- 150";                                                                       // Change la reponse 2
            rep3.innerHTML = "- 100";                                                                       // Change la reponse 3
            rep4.innerHTML = "- 200";                                                                       // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.mathe[1][1];        // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.mathe[1][1]= score;                  // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau moyen du test de mathe !");                     // Afficher message pour félicité
