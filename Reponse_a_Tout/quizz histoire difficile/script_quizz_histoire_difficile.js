...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Dans quelle ville s'est tenue la conférence qui a divisé l'Allemagne en zones d'occupation après la Seconde Guerre mondiale ?";// Met la question de la 2
            rep1.innerHTML = "- Potsdam";                                                                   // Change la reponse 1
            rep2.innerHTML = "- Berlin";                                                                    // Change la reponse 2
            rep3.innerHTML = "- Genève";                                                                    // Change la reponse 3
            rep4.innerHTML = "- Varsovie";                                                                  // Change la reponse 4
            ...
            question.innerText = "3. Quel peuple antique a construit le site de Machu Picchu ?";            // Met la question de la 2
            rep1.innerHTML = "- Les Aztèques";                                                              // Change la reponse 1
            rep2.innerHTML = "- Les Mayas";                                                                 // Change la reponse 2
            rep3.innerHTML = "- Les Incas";                                                                 // Change la reponse 3
            rep4.innerHTML = "- Les Olmèques";                                                              // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.histoire[2][1];     // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.histoire[2][1]= score;               // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau difficile du test d'histoire !");               // Afficher message pour félicité
