...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Quelle est la moitié de 20 ?";                                         // Met la question de la 2
            rep1.innerHTML = "- 5";                                                                         // Change la reponse 1
            rep2.innerHTML = "- 10";                                                                        // Change la reponse 2
            rep3.innerHTML = "- 15";                                                                        // Change la reponse 3
            rep4.innerHTML = "- 8";                                                                         // Change la reponse 4
            ...
            question.innerText = "3. Combien de côtés a un triangle ?";                                     // Met la question de la 2
            rep1.innerHTML = "- 3";                                                                         // Change la reponse 1
            rep2.innerHTML = "- 4";                                                                         // Change la reponse 2
            rep3.innerHTML = "- 5";                                                                         // Change la reponse 3
            rep4.innerHTML = "- 6";                                                                         // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.mathe[0][1];        // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.mathe[0][1]= score;                  // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau facile du test de mathe !");                    // Afficher message pour félicité
