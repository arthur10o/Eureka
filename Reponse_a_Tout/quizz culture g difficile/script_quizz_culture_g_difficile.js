...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = '2. Quel écrivain est l’auteur des "Misérables" ?';                        // Met la question de la 2
            rep1.innerHTML = "- Gustave Flaubert";                                                          // Change la reponse 1
            rep2.innerHTML = "- Victor Hugo";                                                               // Change la reponse 2
            rep3.innerHTML = "- Émile Zola";                                                                // Change la reponse 3
            rep4.innerHTML = "- Alexandre Dumas";                                                                  // Change la reponse 4
            ...
            question.innerText = '3. Quelle planète est surnommée "l’étoile du berger" ?';                  // Met la question de la 2
            rep1.innerHTML = "- Mars";                                                                      // Change la reponse 1
            rep2.innerHTML = "- Jupiter";                                                                   // Change la reponse 2
            rep3.innerHTML = "- Vénus";                                                                     // Change la reponse 3
            rep4.innerHTML = "- Saturne";                                                                   // Change la reponse 4
            ...
            question.innerText = '4. Quel est l’ingrédient principal du guacamole ?';                       // Met la question de la 2
            rep1.innerHTML = "- Poivron";                                                                   // Change la reponse 1
            rep2.innerHTML = "- Avocat";                                                                    // Change la reponse 2
            rep3.innerHTML = "- Courgette";                                                                 // Change la reponse 3
            rep4.innerHTML = "- Concombre";                                                                 // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.culture_G[2][1];// Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.culture_G[2][1]= score;                // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau difficile du test de culture G !");             // Afficher message pour félicité
