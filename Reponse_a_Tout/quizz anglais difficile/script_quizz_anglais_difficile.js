...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Which of the following sentences is correct?";                         // Met la question de la 2
            rep1.innerHTML = "- I have been to Paris last year.";                                           // Change la reponse 1
            rep2.innerHTML = "- I went to Paris last year.";                                                // Change la reponse 2
            rep3.innerHTML = "- I have gone to Paris last year.";                                           // Change la reponse 3
            rep4.innerHTML = "- I have been Paris last year.";                                              // Change la reponse 4
            ...
            question.innerText = '3. Choose the correct form of the adjective: "This test is ______ than the last one."';// Met la question de la 3
            rep1.innerHTML = "- hardest";                                                                   // Change la reponse 1
            rep2.innerHTML = "- hard";                                                                      // Change la reponse 2
            rep3.innerHTML = "- harder";                                                                    // Change la reponse 3
            rep4.innerHTML = "- more hard";                                                                 // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.Anglais[2][1];      // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.Anglais[2][1]= score;                // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau difficile du test d'anglais !");                // Afficher message pour félicité
