...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Which is the correct spelling?";                                       // Met la question de la 2
            rep1.innerHTML = "- Friend";                                                                    // Change la reponse 1
            rep2.innerHTML = "- Frind";                                                                     // Change la reponse 2
            rep3.innerHTML = "- Frend";                                                                     // Change la reponse 3
            rep4.innerHTML = "- Fiend";                                                                     // Change la reponse 4
            ...
            question.innerText = '3. What is the opposite of "big"?';                                       // Met la question de la 2
            rep1.innerHTML = "- Tall";                                                                      // Change la reponse 1
            rep2.innerHTML = "- Short";                                                                     // Change la reponse 2
            rep3.innerHTML = "- Small";                                                                     // Change la reponse 3
            rep4.innerHTML = "- Old";                                                                       // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.Anglais[0][1];// Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.Anglais[0][1]= score;                // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau facile du test d'anglais !");                   // Afficher message pour félicité
