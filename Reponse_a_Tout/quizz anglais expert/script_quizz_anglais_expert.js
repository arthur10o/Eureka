...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Which sentence uses the correct conditional form?";                    // Met la question de la 2
            rep1.innerHTML = "- If I would have known, I would have told you.";                             // Change la reponse 1
            rep2.innerHTML = "- If I know him, I will help you.";                                           // Change la reponse 2
            rep3.innerHTML = "- If I had known, I would have told you.";                                    // Change la reponse 3
            rep4.innerHTML = "- If I would known, I will help you.";                                        // Change la reponse 4
            ...
            question.innerText = '3. Which is the correct version of the following sentence? "By the time we arrived, they ______ already eaten."';// Met la question de la 2
            rep1.innerHTML = "- have";                                                                   // Change la reponse 1
            rep2.innerHTML = "- had";                                                                      // Change la reponse 2
            rep3.innerHTML = "- will have";                                                                      // Change la reponse 3
            rep4.innerHTML = "- will had";                                                                      // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.Anglais[3][1];      // Récupére l'ancien meilleur score                        
                    if(meilleur_score < score){                                                             // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.Anglais[3][1]= score;                // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau expert du test d'anglais !");                      // Afficher message pour félicité
