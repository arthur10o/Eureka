...
async function verifier_reponse(réponse_selec) {
    ...
    if (réponse_selec == rep_corect){                                                                       // Vérifie si la réponse séléctionner est correct
        ...
        if(num_question == 1){                                                                              // Si c'est la 1er question
            question.innerText = "2. Quel pays a remporté la bataille de Tsushima en 1905 ?";               // Met la question de la 2
            rep1.innerHTML = "- La Russie";                                                                 // Change la reponse 1
            rep2.innerHTML = "- Le Japon";                                                                  // Change la reponse 2
            rep3.innerHTML = "- La Chine";                                                                  // Change la reponse 3
            rep4.innerHTML = "- La Corée";                                                                  // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            num_question = 2;                                                                               // Met à jour le numéro de la question
        }
        else  if(num_question == 2){                                                                        // Si c'est la 2eme question
            question.innerText = "3. Quel traité a mis fin à la guerre de Trente Ans en 1648 ?";            // Met la question de la 2
            rep1.innerHTML = "- Le traité de Versailles";                                                   // Change la reponse 1
            rep2.innerHTML = "- Le traité de Westphalie";                                                   // Change la reponse 2
            rep3.innerHTML = "- Le traité de Tordesillas";                                                  // Change la reponse 3
            rep4.innerHTML = "- Le traité d'Utrecht";                                                       // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            num_question = 3;                                                                               // Met à jour le numéro de la question par un 0 pour dire que c'est fini
        }
        else  if(num_question == 3){                                                                        // Si c'est la 3eme question
            question.innerText = "4. Quel était le nom du navire qui a transporté les Pèlerins vers l'Amérique en 1620 ?";// Met la question de la 2
            rep1.innerHTML = "- Santa Maria";                                                               // Change la reponse 1
            rep2.innerHTML = "- Mayflower";                                                                 // Change la reponse 2
            rep3.innerHTML = "- Endeavour";                                                                 // Change la reponse 3
            rep4.innerHTML = "- Beagle";                                                                    // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            num_question = 4;                                                                               // Met à jour le numéro de la question par un 0 pour dire que c'est fini
        }
        else  if(num_question == 4){                                                                        // Si c'est la 4eme question
            question.innerText = "5. Quel roi d'Angleterre a été exécuté en 1649 ?";                        // Met la question de la 2
            rep1.innerHTML = "- Henri VIII";                                                                // Change la reponse 1
            rep2.innerHTML = "- Charles Ier";                                                               // Change la reponse 2
            rep3.innerHTML = "- Richard III";                                                               // Change la reponse 3
            rep4.innerHTML = "- Édouard VI";                                                                // Change la reponse 4
            rep_corect = "rep2";                                                                            // Change la reponse valide
            num_question = 5;                                                                               // Met à jour le numéro de la question par un 0 pour dire que c'est fini
        }
        else  if(num_question == 5){                                                                        // Si c'est la 5eme question
            question.innerText = "6. Quel pays a utilisé le code secret Navajo pendant la Seconde Guerre mondiale ?";// Met la question de la 2
            rep1.innerHTML = "- L'Allemagne";                                                               // Change la reponse 1
            rep2.innerHTML = "- Le Japon";                                                                  // Change la reponse 2
            rep3.innerHTML = "- Les États-Unis";                                                            // Change la reponse 3
            rep4.innerHTML = "- Le Royaume-Uni";                                                            // Change la reponse 4
            ...
            if(etat_connexion == "true"){                                                                   // Si l'utilisateur est connecté alors sauvegarder le calcul dans le local storage
                ...
                if(chercher_utilisateur){                                                                   // Si l'utilisateur connecté est trouvé :
                    let meilleur_score = chercher_utilisateur.stat_meilleur_score.quizz.histoire[3][1]; // Récupére l'ancien meilleur score                        
                if(meilleur_score < score){                                                                 // Si l'ancien meilleur score est inférieur au score que l'utilisateur vient de faire
                        chercher_utilisateur.stat_meilleur_score.quizz.histoire[3][1]= score;               // Alors mettre a jour le meilleur score
                        localStorage.setItem("utilisateurs", JSON.stringify(info_joueur));                  // Enregistre les infos du joueur mis à jour
                    }                                                             
                }
            }
            alert("Félicitations ! Vous avez fini le niveau expert du test d'histoire !");                  // Afficher message pour félicité
...
let rep_corect = "rep3";                                                                                    // Définit la bonne réponse
