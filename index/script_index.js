...
function activer_mode_sombre() {
    ...
    document.getElementById("img_logo").src ="images/logo_accueil_allumé.png";                              // Change le logo
    image_une.src = "images/image_promo_calcul_tout_claire.png";                                            // Change l'image de promotion du calcul'tout
    image_deux.src = "images/photo_promo_reponse_a_tout_claire.png";                                        // Change l'image de promotion du reponse à tout
    image_trois.src = "images/image_promo_converti_tout_claire.png";                                        // Change l'image de promotion du converti'tout
    image_quatre.src = "images/image promotion ecrit tout claire.png";                                      // Change l'image de promotion du ecrit'tout
    ...
    for (let i = 0; i < zone_jeux.length; i++){                                                             // Boucle pour parcourir tous les élements de la class = "liste_jeux"
        zone_jeux[i].style.color = couleur_fonce;                                                           // Change la couleur des éléments de la class = "liste_jeux" un par un
        zone_jeux[i].style.backgroundColor = couleur_claire;                                                // Change le background des éléments de la class = "liste_jeux" un par un
    }
...
function activer_mode_clair() {
    ...
    document.getElementById("img_logo").src ="images/logo_accueil_eteint.png";                              // Change le logo
    image_une.src = "images/image_promo_calcul_tout_fonce.png";                                             // Change l'image de promotion du calcul'tout
    image_deux.src = "images/photo_promo_reponse_a_tout_fonce.png";                                         // Change l'image de promotion du reponse à tout
    image_trois.src = "images/image_promo_converti_tout_fonce.png";                                         // Change l'image de promotion du converti'tout
    image_quatre.src = "images/image promotion ecrit tout fonce.png";                                       // Change l'image de promotion du ecrit'tout
    ...
    for (let i = 0; i < zone_jeux.length; i++){                                                             // Boucle pour parcourir tous les élements de la class = "icon"
        zone_jeux[i].style.color = couleur_claire;                                                          // Change la couleur des éléments de la class = "liste_jeux" un par un
        zone_jeux[i].style.backgroundColor = couleur_fonce;                                                 // Change le background des éléments de la class = "liste_jeux" un par un
    }
    for (let i = 0; i < boxShadow.length; i++){                                                             // Boucle pour parcourir tous les élements de la class = "boxshadow"
...
let zone_jeux = document.getElementsByClassName("liste_jeux");                                              // Sélectionne les élements avec la class = "liste_jeux"
...
let image_une = document.getElementById("img_une");
let image_deux = document.getElementById("img_deux");
let image_trois = document.getElementById("img_trois");
let image_quatre = document.getElementById("img_quatre");
